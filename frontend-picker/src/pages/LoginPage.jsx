  ...
  return (
    ...
    <div className="min-h-screen flex justify-center items-center bg-green-100 p-4">
      ...
      >
        ...
        <button
          className="w-full bg-green-600 hover:bg-green-700 text-white p-4 rounded-2xl text-xl font-bold"
        >
